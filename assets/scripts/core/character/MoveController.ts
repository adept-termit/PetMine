...
import {Animator} from "db://assets/scripts/core/character/Animator";
import {gameInput} from "db://assets/scripts/core/character/input/GameInput";
...
export class MoveController extends Component {
    ...
    @property({type: Node}) camera: Node; // Камера
